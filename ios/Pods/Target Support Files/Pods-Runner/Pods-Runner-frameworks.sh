...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_new_badger/flutter_new_badger.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_sensors/flutter_sensors.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/media_kit_native_event_loop/media_kit_native_event_loop.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/qr_code_scanner_plus/qr_code_scanner_plus.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/sound_mode/sound_mode.framework"
