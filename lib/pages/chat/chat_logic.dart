  ...
  void revokeMessage(Message message) async {
    try {
      ...
      if (!_canRevokeMessage(message)) {
        IMViews.showToast('消息发送时间超过2分钟，无法撤回');
        return;
      }
        ...
        AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text('确定', style: TextStyle(color: Styles.c_FF381F)),
            ),
          ],
        ),
      );
      ...
      Logger.print('撤回消息失败: $e');
      IMViews.showToast('撤回失败，请重试');
    }
  }
